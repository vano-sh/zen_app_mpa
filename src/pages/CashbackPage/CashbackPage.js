...
import { useAnimateRef, useData, useForm, useTheme } from 'shared/model'
      ...
      >
        <div className={classes.wrapper}>
          ...
          <div className={classes.body}>
            {cashback.texts.length > 0 && cashback.texts.map((text) =>
          ...
          <button
            ref={orderBtnRef}
            className={classNames(classes.btn, { 'dark': theme === 'dark' })}
